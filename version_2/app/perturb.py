...
def leave_one_out(full_text: str, unit: str) -> List[str]:
    """
    Paper-faithful implementation: remove the entire unit from the full context
    text (not word-level removal). Matches leave_one_out_perturber.py in the
    official fraunhofer-iais/explainable-lms repository:
